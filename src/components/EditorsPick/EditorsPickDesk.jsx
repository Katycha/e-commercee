...
import Pic1 from "@/assets/filter.png";
import Pic2 from "@/assets/filter2.png";
import Pic3 from "@/assets/filter3.png";
import Pic4 from "@/assets/filter4.png";


const EditorsPickDesk = () => {
  return (
    <div className="tw-hidden md:tw-block tw-justify-center tw-items-center tw-mx-[150px]">
     
        <div className="tw-flex tw-flex-col tw-gap-y-4 tw-text-center">
