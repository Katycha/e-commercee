...
const VitaClassicMob = () => {
  return (
    <div className="tw-flex tw-flex-col md:tw-hidden  tw-pt-[208px] tw-bg-[#23856D] tw-justify-center tw-mb-[40px]">
...
<Button variant="contained" className="tw-bg-[#2DC071] tw-w-[170px] ">
            add to cart
          </Button>
        </div>
